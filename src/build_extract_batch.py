        ...
        for i, img in enumerate(pages, start=1):
            ...
            if args.mode == "combined":
                ...
                if all(k in by_kind for k in ("wind", "precipitation", "temperature")):
                    ...
                    req["custom_id"] = f"extract::{Path(pdf).name}::p{i}::combined"
                    items.append(req)
                continue
