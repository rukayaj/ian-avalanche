...
- Wind speed (blue line), integer mph aligned with the axis ticks; make sure you select the tick that the blue line actually crosses.
- Wind gust (pink line), integer mph aligned with the axis ticks; confirm the pink line does not drift above the scale before reading.
...
- Before filling the full series, read the 18:00 speed and gust directly from the axis grid to establish the correct scale, then apply that calibration to the remaining hours.
